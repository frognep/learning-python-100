...
image = "day26_LIST_COMPREHENSION\\day-25-us-states-game-start\\blank_states_img.gif"
...
# -----------------------
states_file = pd.read_csv("day26_LIST_COMPREHENSION\\day-25-us-states-game-start\\50_states.csv")
...
while len(states_correctly_guessed) != 50:
    ...
    if user_input.lower() == "exit":
        states_not_guessed = [state for state in state_list if state not in states_correctly_guessed]
        # utilizing g4g on knowledge on converting list to a dataframe for csv conversion
        df = pd.DataFrame(states_not_guessed)
        df.to_csv("day26_LIST_COMPREHENSION\\day-25-us-states-game-start\\incorrect.csv")
        break
